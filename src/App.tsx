  ...
  return (
    <>
      <Container className="pt-2 partial-center">
        ...
        <p>
          I am an engineer at <a href="https://www.mediatek.com/">Mediatek</a>,
          where I work on computer vision and machine learning.
        </p>
        <p>
          At Mediatek, I work on mobile computational photography with deep
          learning. And, my research is in the field of image restoration and
          enhancement, camera pose estimation with machine learning. I did my
          undergraduate and bachelors studies at{" "}
